...
const ConfirmDeleteModal = ({ modal, setModal,  confirmFunction, setDeleteId }) => {
  return (
    <>
      <CustomModal modal={modal} setModal={setModal} classes={{ modalClass: 'theme-modal delete-modal', modalHeaderClass: 'p-0' }}>
        ...
        <div className='button-box'>
          ...
          />
          <Btn title='Yes' className='theme-bg-color btn-md fw-bold text-light' onClick={confirmFunction} />
        </div>
      </CustomModal>
    </>
  );
